 ...
 */
public class CustomFunctionsPanel
  extends JPanel
  ...
  static {
	...
	throw new Exception(
	    Messages.getInstance().getString("CustomFunctionsPanel_Exception_Text_First"));
      }
    }
    catch (Exception ex) {
      JOptionPane.showMessageDialog(
	  null,
	  Messages.getInstance().getString("CustomFunctionsPanel_Exception_JOptionPaneShowMessageDialog_Text_First")
	  + PROPERTY_FILE 
	  + Messages.getInstance().getString("CustomFunctionsPanel_Exception_JOptionPaneShowMessageDialog_Text_Second") 
	  + System.getProperties().getProperty("user.home") 
	  + Messages.getInstance().getString("CustomFunctionsPanel_Exception_JOptionPaneShowMessageDialog_Text_Third"),
	  Messages.getInstance().getString("CustomFunctionsPanel_Exception_JOptionPaneShowMessageDialog_Text_Fourth"),
  ...
  class ClassRunner extends Thread {
	...
	throw new NoSuchMethodException(Messages.getInstance().getString("CustomFunctionsPanel_ClassRunner_Exception_NoSuchMethodException_Text_First") +
					theClass.getName() +
					Messages.getInstance().getString("CustomFunctionsPanel_ClassRunner_Exception_NoSuchMethodException_Text_Second"));
      }
    }
	...
	if (isInterrupted()) {
	  System.err.println(Messages.getInstance().getString("CustomFunctionsPanel_ClassRunner_Run_Error_Text_First"));
	}
      } catch (Exception ex) {
	if (ex.getMessage() == null) {
	  System.err.println(Messages.getInstance().getString("CustomFunctionsPanel_ClassRunner_Run_Error_Text_Second"));
	} else {
	  System.err.println(Messages.getInstance().getString("CustomFunctionsPanel_ClassRunner_Run_Error_Text_Third") + ex.getMessage());
	}
      } finally {
	m_RunThread = null;
      }
	...
	outNew.close();
	System.setOut(outOld);
	System.out.println(Messages.getInstance().getString("CustomFunctionsPanel_ClassRunner_Run_Text_First") + outFilename + Messages.getInstance().getString("CustomFunctionsPanel_ClassRunner_Run_Text_Second"));
      }
    }
  }
  ...
  public static class CommandlineCompletion {
    ...
    public Vector<String> getFileMatches(String partial) {
      ...
      if (m_Debug)
	System.out.println(Messages.getInstance().getString("CustomFunctionsPanel_CommandlineCompletion_GetFileMatches_Text_First") + caseSensitive);
	...
	prefix = file.getName();
      ...
      if (m_Debug)
	System.out.println(Messages.getInstance().getString("CustomFunctionsPanel_CommandlineCompletion_GetFileMatches_Text_Second") + dir + Messages.getInstance().getString("CustomFunctionsPanel_CommandlineCompletion_GetFileMatches_Text_Third") + prefix);
	...
	if (files != null) {
	  ...
	  System.err.println(Messages.getInstance().getString("CustomFunctionsPanel_CommandlineCompletion_GetFileMatches_Error_Text") + partial);
	}
      }
	...
	Collections.sort(result);
      ...
      // print results
      if (m_Debug) {
	System.out.println(Messages.getInstance().getString("CustomFunctionsPanel_CommandlineCompletion_GetFileMatches_Text_Third"));
    ...
    public Vector<String> getClassMatches(String partial) {
      ...
      if (getDebug())
	System.out.println(
			Messages.getInstance().getString("CustomFunctionsPanel_CommandlineCompletion_GetClassMatches_Text_First") + partial + Messages.getInstance().getString("CustomFunctionsPanel_CommandlineCompletion_GetClassMatches_Text_Second") + pkg + Messages.getInstance().getString("CustomFunctionsPanel_CommandlineCompletion_GetClassMatches_Text_Third") + cls);
	...
	Collections.sort(result);
      ...
      // print results
      if (m_Debug) {
	System.out.println(Messages.getInstance().getString("CustomFunctionsPanel_CommandlineCompletion_GetClassMatches_Text_Fifth"));
	for (i = 0; i < result.size(); i++)
	  System.out.println(result.get(i));
      }
    ...
    public String getCommonPrefix(Vector<String> list) {
      ...
      if (m_Debug)
	System.out.println(list + Messages.getInstance().getString("CustomFunctionsPanel_CommandlineCompletion_GetCommonPrefix_Text_First") + result + Messages.getInstance().getString("CustomFunctionsPanel_CommandlineCompletion_GetCommonPrefix_Text_Second"));
   ...
   * @throws Exception if an error occurs
   */
  public CustomFunctionsPanel() throws Exception {
    
    setLayout(new BorderLayout());
    add(new JScrollPane(m_OutputArea), Messages.getInstance().getString("CustomFunctionsPanel_JScrollPane_Text_First"));
    add(m_Input, Messages.getInstance().getString("CustomFunctionsPanel_JScrollPane_Text_Second"));
    ...
    System.out.println(
    Messages.getInstance().getString("CustomFunctionsPanel_JScrollPane_Text_Third")
	+ File.separator 
	+ Messages.getInstance().getString("CustomFunctionsPanel_JScrollPane_Text_Fouth"));
    runCommand(Messages.getInstance().getString("CustomFunctionsPanel_RunCommand_Text"));
  ...
  public void runCommand(String commands) throws Exception {
	...
	if (commandArgs.length == 1) {
	  throw new Exception(Messages.getInstance().getString("CustomFunctionsPanel_RunCommand_Exception_Text_First"));
	}
	String className = commandArgs[1];
	commandArgs[1] = "";
	if (m_RunThread != null) {
	  throw new Exception(Messages.getInstance().getString("CustomFunctionsPanel_RunCommand_Exception_Text_Second"));
	}
	...
	System.err.println(ex.getMessage());
      ...
      System.out.println(Messages.getInstance().getString("CustomFunctionsPanel_RunCommand_Text_First"));
      for (int i = 0; i < m_CommandHistory.size(); i++)
	System.out.println(m_CommandHistory.get(i));
      System.out.println();
    } else if (commandArgs[0].equals("break")) {
      if (m_RunThread == null) {
	System.err.println(Messages.getInstance().getString("CustomFunctionsPanel_RunCommand_Error_Text_First"));
      } else {
	System.out.println(Messages.getInstance().getString("CustomFunctionsPanel_RunCommand_Text_Second"));
	m_RunThread.interrupt();
      }
    } else if (commandArgs[0].equals("kill")) {
      if (m_RunThread == null) {
	System.err.println(Messages.getInstance().getString("CustomFunctionsPanel_RunCommand_Error_Text_Second"));
      } else {
	System.out.println(Messages.getInstance().getString("CustomFunctionsPanel_RunCommand_Text_Third"));
	m_RunThread.stop();
	m_RunThread = null;
      }
	...
	System.err.println(
			Messages.getInstance().getString("CustomFunctionsPanel_RunCommand_Error_Text_Third") 
	    + File.separator 
	    + Messages.getInstance().getString("CustomFunctionsPanel_RunCommand_Error_Text_Fourth"));
      } else if (help && commandArgs[1].equals("break")) {
	System.err.println(
			Messages.getInstance().getString("CustomFunctionsPanel_RunCommand_Error_Text_Fifth"));
      } else if (help && commandArgs[1].equals("kill")) {
	System.err.println(
			Messages.getInstance().getString("CustomFunctionsPanel_RunCommand_Error_Text_Sixth"));
      } else if (help && commandArgs[1].equals("cls")) {
	System.err.println(
			Messages.getInstance().getString("CustomFunctionsPanel_RunCommand_Error_Text_Seventh"));
      } else if (help && commandArgs[1].equals("history")) {
	System.err.println(
			Messages.getInstance().getString("CustomFunctionsPanel_RunCommand_Error_Text_Eighth"));
      } else if (help && commandArgs[1].equals("exit")) {
	System.err.println(
			Messages.getInstance().getString("CustomFunctionsPanel_RunCommand_Error_Text_Nineth"));
      } else {
	// Print a help message
	System.err.println(
			Messages.getInstance().getString("CustomFunctionsPanel_RunCommand_Error_Text_Tenth"));
      }
    }
  }
	  ...
	  if (e.getModifiers() == 0) {
		...
		if (nonNameCharPos > -1) {
		  ...
		  // ambigiuous? -> print matches
		    ...
		    System.out.println(Messages.getInstance().getString("CustomFunctionsPanel_DoCommandlineCompletion_Text"));
		    for (int i = 0; i < list.size(); i++)
  ...
  protected void saveHistory() {
    ...
    try {
      ...
      PROPERTIES.store(stream, "CustomFunctions");
      stream.close();
    }
    catch (Exception e) {
      e.printStackTrace();
  ...
  public static void main(String[] args) throws Exception {
    CustomFunctionsPanel panel = new CustomFunctionsPanel();
    JFrame f = new JFrame();
    f.setTitle(Messages.getInstance().getString("CustomFunctionsPanel_Main_JFrame_SetText_Text"));

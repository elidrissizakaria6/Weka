 ...
 */
public class LinearNNSearchCustomized
  extends NearestNeighbourSearchCustomized { //TODO: done change NearestNeighbourSearch by NearestNeighbourSearchCustomized
   ...
   */
  public LinearNNSearchCustomized() {
    super();
  }
   ...
   */
  public LinearNNSearchCustomized(Instances insts) {
    super(insts);

...
import weka.core.ManhattanDistance;   //TODO: Done replace EuclideanD by ManhattanD
...
public abstract class NearestNeighbourSearchCustomized
  ...
  /**
	 * 
	 */
	private static final long serialVersionUID = 1L;   //TODO: done something
...
/**
  ...
  protected DistanceFunction m_DistanceFunction = new ManhattanDistance(); //TODO: Done replace EuclideanD by ManhattanD
   ...
   * Constructor.
   */
  public NearestNeighbourSearchCustomized() {
   ...
   */
  public NearestNeighbourSearchCustomized(Instances insts) {
    this();
    m_Instances = insts;
  }
  ...
  //TODO: Done replace EuclideanD by ManhattanD
    newVector.add(new Option(
	"\tDistance function to use.\n"
	+ "\t(default: weka.core.ManhattanDistance)", 

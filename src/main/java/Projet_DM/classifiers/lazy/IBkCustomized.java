...
package Projet_DM.classifiers.lazy;
...
import weka.core.neighboursearch.LinearNNSearchCustomized; //TODO
import weka.core.neighboursearch.NearestNeighbourSearchCustomized; //TODO: done change NearestNeighbourSearch by NearestNeighbourSearchCustomized
...
public class IBkCustomized 
  ...
  protected NearestNeighbourSearchCustomized m_NNSearch = new LinearNNSearchCustomized(); //TODO: done change NearestNeighbourSearch by NearestNeighbourSearchCustomized
   ...
   */
  public NearestNeighbourSearchCustomized getNearestNeighbourSearchAlgorithm() { //TODO
    return m_NNSearch;
  }
   ...
   */
  public void setNearestNeighbourSearchAlgorithm(NearestNeighbourSearchCustomized nearestNeighbourSearchAlgorithm) { //TODO: done change NearestNeighbourSearch by NearestNeighbourSearchCustomized
  ...
  public void setOptions(String[] options) throws Exception {
    ...
    if(nnSearchClass.length() != 0) {
      ...
      setNearestNeighbourSearchAlgorithm( (NearestNeighbourSearchCustomized) //TODO
                  Utils.forName( NearestNeighbourSearchCustomized.class, 
                                 className, 
                                 nnSearchClassSpec)
                                        );
    }
    else 
      this.setNearestNeighbourSearchAlgorithm(new LinearNNSearchCustomized()); //TODO
  ...
  protected void crossValidate() {
    ...
    try {
      if (m_NNSearch instanceof weka.core.neighboursearch.CoverTreeCustomized) //TODO
  ...
  public static void main(String [] argv) {
    runClassifier(new IBkCustomized(), argv);
  }
}
